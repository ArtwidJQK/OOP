...
// exception handling right there (in adding bill function)
    private void luuHoaDon() {
        try {
            HoaDonRequest request = new HoaDonRequest(); // tạo đối tượng DTO HoaDonRequest (1)
            ...
            HoaDonResponse response = service.them(request); // gọi service ( xử lý logic ) để thêm hóa đơn (2)
            if (response.success) {
