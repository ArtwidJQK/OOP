...
public class QLHoaDonMenuGUI extends JFrame {
    ...
    private void initUI() {
        ...
        JMenuItem inDSHD = new JMenuItem("4. In DS Hóa đơn");
        inDSHD.addActionListener(e -> new InDanhSachDialog(inDSService));
        chucNang.add(inDSHD);

        chucNang.addSeparator();

        JMenuItem thongKe = new JMenuItem("5. Thống kê Theo Loại");
        ...
        JLabel lbFooter = new JLabel("Được phát triển bởi GDUers", SwingConstants.CENTER);
